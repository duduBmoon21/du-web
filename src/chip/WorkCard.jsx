        ...
        return (
          ...
          >
            <POPUP className="img-content relative">
              ...
              <div
                className={` popup w-full  h-[280px] shadow-xl 
                rounded-md overflow-hidden sm:h-[260px] sm:w-[92%] p-4`}
              >
                ...
                <div className=" flex items-center justify-center gap-4">
                  <Link
                    className="  mt-3 rounded-md shadow-md p-1 px-2 flex
                     gap-2 items-center justify-center font-medium"> 
